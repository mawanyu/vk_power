...
#define ADC_CH_BAT_CHARGE    (ADC10INCH_1)   /* Battery charge I channel */
#define ADC_CH_FAN           (ADC10INCH_2)   /* Fan V channel */
#define ADC_CH_INTERBAT      (ADC10INCH_3)   /* Internal battery V channel */
...
#define ADC_CH_SYS_IN        (ADC10INCH_13)  /* Input V channel of system, one of AC/DC, DC/DC and internel battery */
#define ADC_CH_BACKUPBAT     (ADC10INCH_14)  /* Backup battery V channel */
...
extern unsigned int adcr_bat_charge;    /* battery charge I */
extern unsigned int adcr_fan;           /* fan V */
extern unsigned int adcr_inter_bat;     /* internal battery V */
extern unsigned int adcr_backup_bat;    /* backup battery V */
...
unsigned char adc_complete_flag;
